...
final class VoiceMessageRecordingView: UIView {
    ...
    private lazy var iconImageView: UIImageView = {
        ...
        result.image = UIImage(named: "icon_chats_voice")?
    ...
    private lazy var circleView: UIView = {
        ...
        result.themeBackgroundColor = .messageBubble_outgoingBackground
    ...
    private func setUpViewHierarchy() {
        ...
        self.sendSubviewToBack(lockView)
    }
        ...
        if isValidLockViewLocation(location) {
            if !lockView.isExpanded {
                UIView.animate(withDuration: 0.25) {
                    self.lockViewBottomConstraint.constant = LockView.expansionMargin
                }
            }
...
extension VoiceMessageRecordingView {
    fileprivate final class LockView: UIView {
        ...
        private lazy var stackView: UIStackView = {
            ...
            result.layoutMargins = UIEdgeInsets(top: 12, leading: 0, bottom: 58, trailing: 0)
        ...
        private func setUpViewHierarchy() {
            ...
            let lockIconImageView: UIImageView = UIImageView(
                image: UIImage(named: "icon_chats_lock")?
                    .withRenderingMode(.alwaysTemplate)
            )
            ...
            let chevronIconImageView: UIImageView = UIImageView(
                image: UIImage(named: "icon_chats_upArrow")?
                    .withRenderingMode(.alwaysTemplate)
            )
