...
final class InputView: UIView, InputViewButtonDelegate, InputTextViewDelegate, MentionSelectionViewDelegate {
    ...
    private lazy var voiceMessageButton: InputViewButton = {
        let result = InputViewButton(icon: UIImage(named: "icon_chats_voice"), delegate: self)
    ...
    private lazy var sendButton: InputViewButton = {
        let result = InputViewButton(icon: UIImage(named: "icon_chats_send"), iconTintColor: .messageBubble_outgoingBackground,  delegate: self)
    ...
    private func setUpViewHierarchy() {
        ...
        // Background & blur
        let backgroundView = UIView()
        backgroundView.themeBackgroundColor = .tab_select_bg
//        backgroundView.alpha = Values.lowOpacity
...
//        separator.pin([ UIView.HorizontalEdge.leading, UIView.VerticalEdge.top, UIView.HorizontalEdge.trailing ], to: self)
        ...
        rightView.set(.width, to: 10.w)
        rightView.set(.height, to: 10.w)
        
        // Bottom stack view
        let bottomStackView = UIStackView(arrangedSubviews: [ attachmentsButton, inputTextView, container(for: sendButton),rightView])
