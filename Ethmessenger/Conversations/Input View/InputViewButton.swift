...
final class InputViewButton: UIView {
    ...
    private var iconTintColor : ThemeValue?
    ...
    init(icon: UIImage?, isSendButton: Bool = false,iconTintColor : ThemeValue? = nil, delegate: InputViewButtonDelegate? = nil, hasOpaqueBackground: Bool = false, onTap: (() -> Void)? = nil) {
        self.icon = icon
...
//        backgroundView.pin(to: self)
        ...
        iconImageView.themeTintColor = self.iconTintColor == nil ? (isSendButton ? .black : .textPrimary) : self.iconTintColor
