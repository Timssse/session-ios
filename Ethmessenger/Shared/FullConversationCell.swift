...
public final class FullConversationCell: BaseTableViewCell {
    ...
    private func setUpViewHierarchy() {
        ...
        profilePictureView.snp.makeConstraints { make in
            ...
            make.bottom.equalToSuperview().offset(-24.w)
            make.size.equalTo(CGSize(width: 52, height: 52))
        }
        
        contentView.addSubview(displayNameLabel)
        displayNameLabel.snp.makeConstraints { make in
            make.left.equalTo(profilePictureView.snp.right).offset(18.w)
            make.top.equalToSuperview().offset(27)
        }
        
        contentView.addSubview(isPinnedIcon)
        isPinnedIcon.snp.makeConstraints { make in
            make.left.equalTo(displayNameLabel.snp.right).offset(5.w)
            make.centerY.equalTo(displayNameLabel)
            make.size.equalTo(CGSize(width: FullConversationCell.unreadCountViewSize, height: FullConversationCell.unreadCountViewSize))
        }
        
//        contentView.addSubview(hasMentionView)
//        hasMentionView.snp.makeConstraints { make in
//            make.left.equalTo(displayNameLabel.snp.right).offset(5.w)
...
//        }
        ...
        typingIndicatorView.snp.makeConstraints { make in
            make.left.equalTo(snippetLabel.snp.right).offset(5.w)
            make.bottom.equalToSuperview().offset(-27.w)
        }
        ...
        statusIndicatorView.snp.makeConstraints { make in
            make.right.equalToSuperview().offset(-24.w)
            make.centerY.equalTo(snippetLabel)
        }
...
//        bottomLabelStackView.snp.makeConstraints { make in
//            make.right.equalToSuperview().offset(-24.w)
//            make.centerY.equalTo(displayNameLabel)
//        }
...
//        let labelContainerView = UIStackView(arrangedSubviews: [ topLabelStackView, unreadCountView, bottomLabelStackView ])
...
//        labelContainerView.isUserInteractionEnabled = false
        ...
        // Main stack view
//        let stackView = UIStackView(arrangedSubviews: [ profilePictureView, labelContainerView ])
