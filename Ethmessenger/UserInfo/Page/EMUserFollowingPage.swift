...
class EMUserFollowingPage: EMRefreshController {
...
extension EMUserFollowingPage{
    ...
    func getData(){
        ...
        isLoadMore = true
        Task{
            let data = await EMUserController.userFollow(self.page)
...
extension EMUserFollowingPage : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.follow = self.dataArr[indexPath.row]
