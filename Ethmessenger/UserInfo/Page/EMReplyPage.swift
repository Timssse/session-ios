...
class EMReplyPage: EMRefreshController {
    ...
    override func layoutUI() {
        self.title = LocalReply.localized()
...
extension EMReplyPage{
    ...
    func getData(){
        ...
        isLoadMore = true
        Task{
            let data = await EMCommunityController.replyListMe(self.page)
...
extension EMReplyPage : UITableViewDelegate,UITableViewDataSource{
