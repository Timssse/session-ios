...
class EMMomentsUserPage: EMRefreshController ,EMHideNavigationBarProtocol,ThemedNavigation{
...
extension EMMomentsUserPage : UITableViewDelegate,UITableViewDataSource{
