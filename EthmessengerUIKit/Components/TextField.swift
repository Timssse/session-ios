...
public final class TextField: UITextField {
    ...
    static let height: CGFloat = CGFloat(80)
    ...
    public init(placeholder: String, usesDefaultHeight: Bool = true, customHeight: CGFloat? = nil, customHorizontalInset: CGFloat? = nil, customVerticalInset: CGFloat? = nil) {
        ...
        self.horizontalInset = customHorizontalInset ?? (Values.largeSpacing)
        self.verticalInset = customVerticalInset ?? (Values.largeSpacing)
